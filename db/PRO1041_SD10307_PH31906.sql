CREATE DATABASE PRO1041_SD18307_PH31906
GO

USE PRO1041_SD18307_PH31906
GO
...
VALUES
    ...
    ('V002', N'Giảm 150k cho hóa đơn từ 1,500,000 VNĐ', 1500000,  1, 150000, '2023-01-15 05:00:00', '2023-02-15 22:45:00', 200, 2),
    ...
    ('V005', N'Giảm 300k cho hóa đơn từ 3,000,000 VNĐ', 3000000, 1, 300000, '2023-03-01 02:00:00', '2023-04-01 20:45:00', 120, 1),
    ...
    ('V008', N'Giảm 450k cho hóa đơn từ 4,500,000 VNĐ', 4500000, 1, 450000, '2023-04-15 12:00:00', '2023-05-15 22:45:00', 60, 1),
    ('V009', N'Giảm 500k cho hóa đơn từ 5,000,000 VNĐ', 5000000, 1, 500000, '2023-05-01 10:00:00', '2023-06-01 23:45:00', 180, 2),
    ('V010', N'Giảm 55% cho hóa đơn từ 5,500,000 VNĐ', 5500000, 1, 55, '2023-05-15 07:00:00', '2023-06-15 19:00:00', 100, 1);
...
VALUES
	(N'Khách lẻ', 1, '0000000000', N'Địa chỉ mặc định', 'khachle@example.com', '2000-01-15', 1, GETDATE(), GETDATE(), 0, 'KH001',1),
    (N'Nguyễn Văn Tài', 1, '0987654321', N'Quỳnh Lưu - Nghệ An', 'nguyenvantai@example.com', '2000-01-15', 1, GETDATE(), GETDATE(), 0, 'KH002',1),
    (N'Trần Thị Bình', 0, '0123456789', N'Thanh Trì - Hà Nội', 'tranthibinh@example.com', '1995-05-20', 2, GETDATE(), GETDATE(), 0,'KH003',2),
    (N'Lê Văn Chính', 1, '0978563412', N'Đống đa - Hà Nội', 'levanchinh@example.com', '1980-09-10', 1, GETDATE(), GETDATE(),0,'KH004',1),
    (N'Phạm Văn Dũng', 1, '0956743218', N'63 Lê đức thọ - Hà Nội', 'phamvand@example.com', '1992-03-25', 3, GETDATE(), GETDATE(),0,'KH005',2),
    (N'Nguyễn Thị Em', 0, '0912345678', N'Thanh Hóa', 'nguyenthem@example.com', '1998-07-30', 1, GETDATE(), GETDATE(),0, 'KH006',1),
    (N'Trần Văn Phong', 1, '0945632178', N'Quỳnh Long - Nghệ An', 'tranvanf@example.com', '1975-11-05', 2, GETDATE(), GETDATE(),0,'KH007',2),
    (N'Lê thị giang', 0, '0909876543', N'Bình Định', 'lethig@example.com', '1988-12-12', 1, GETDATE(), GETDATE(),0,'KH008',1),
    (N'Phạm Thị Hương', 0, '0932167845', N'Đô Lương - Nghệ An', 'phamthih@example.com', '1990-02-28', 3, GETDATE(), GETDATE(),0,'KH009',1),
    (N'Nguyễn Văn Yến', 1, '0965432178', N'Tràng an - Ninh Bình', 'nguyenvani@example.com', '2002-08-18', 1, GETDATE(), GETDATE(),0,'KH010',1),
    (N'Trần Thị Hiên', 1, '0978563421', N'Kiểu mai - Hà Nội', 'tranvank@example.com', '1994-06-10', 2, GETDATE(), GETDATE(),0,'KH0011',2);
...
INSERT INTO phieu_doi_chi_tiet (gia_ban, ten_san_pham, mau, so_luong_doi, id_san_pham_chi_tiet, id_phieu_doi,id_ly_do_doi,mota,loai)
VALUES
     (25.5, N'Túi xách da nữ', 'Đen',  2, 1, 1,1,N'ảo thật đấy',N'Đổi sản phẩm'),
   (30.0, N'Túi xách đeo chéo', 'Xanh',  1, 2, 2,2,N'ảo thật đấy',N'Đổi sản phẩm'),
    (15.0, N'Túi xách cầm tay', 'Trắng',  3, 3, 3,3,N'ảo thật đấy',N'Đổi sản phẩm')
