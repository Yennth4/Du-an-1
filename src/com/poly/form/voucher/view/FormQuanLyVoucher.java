...
public class FormQuanLyVoucher extends javax.swing.JPanel {
    ...
    public Voucher getForm() {
        ...
        if (ma.isEmpty()) {
            ...
            return null;
        } else if (mucChiTieuToiThieu.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Mức chi tiêu tối thiểu không được để trống");
            return null;
        } else if (soLuong.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Số lượng không được để trống");
            return null;
        } else if (phanTramGiamGia.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Phần trăm giảm giá không được để trống");
            return null;
        }
        try {
            if ((Integer.valueOf(mucChiTieuToiThieu)) <= 0) {
                JOptionPane.showMessageDialog(this, "Mức chi tiêu tối thiểu phải dương");
                return null;
            } else if (Integer.valueOf(soLuong) <= 0) {
                JOptionPane.showMessageDialog(this, "Số lượng phải dương");
                return null;
            } else if (Integer.valueOf(phanTramGiamGia) <= 0) {
                JOptionPane.showMessageDialog(this, "Phần trăm giảm giá phải dương");
                return null;
            } else if (Integer.valueOf(phanTramGiamGia) > 99) {
                JOptionPane.showMessageDialog(this, "Phần trăm giảm giá không được quá 99%");
                return null;
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbId, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 327, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtMa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 326, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(txtMucChiTieuToiThieu, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
