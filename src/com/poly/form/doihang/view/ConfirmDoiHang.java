 ...
 * @author Admin
 */
public class ConfirmDoiHang extends javax.swing.JFrame {
    ...
    private DoiHangChiTiet chiTiet;
    ...
    public ConfirmDoiHang(ProductDetailResponse productDetailResponse, Long idHoaDon, DoiHangChiTiet chiTiet, Boolean doiHang,FormQuanLyDoiHang formQuanLyDoiHang) {
        initComponents();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtSoLuongDoi, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(btnAdd))
                            .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(rdoDoiSanPham, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        if (phieuDoiChiTietService.checkDoiHang(productDetailResponse.getIdsanphamdetail(), idPhieuDoi, lyDoDoi.getId(),rdoDoiSanPham.isSelected()?"Đổi sản phẩm":"Đổi tiền")) {
            phieuDoiChiTietService.addLyDoChiTiet(  soLuongDoi, productDetailResponse.getIdsanphamdetail(), idPhieuDoi, lyDoDoi.getId());
        } else {
            phieuDoiChiTietService.createPhieuDoiChiTiet(productDetailResponse, idPhieuDoi, lyDoDoi.getId(), "-" + txtMoTa.getText(), soLuongDoi,rdoDoiSanPham.isSelected()?"Đổi sản phẩm":"Đổi tiền");
        }
//
        //xóa
        if (soLuongDoi == productDetailResponse.getSoLuong()) {
            ...
            hoaDonService.updateDoiHang(productDetailResponse.getIdHoaDonSanPham(), productDetailResponse.getSoLuong() - soLuongDoi);
        }
        chiTiet.showTable(chiTiet.getDetailService().findProductsById(idHoaDon));
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmDoiHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
