...
public class KMSanPhamRepository {
    ...
    public List<SanPhamForKhuyenMaiResponse> getAllDataSanPham() throws Exception {
        String query = "SELECT sp.IDSanPham, sp.MaSanPham, sp.TenSanPham"
                + " FROM SanPham sp ORDER BY sp.IDSanPham DESC";
    ...
    public List<SanPhamForKhuyenMaiResponse> getAllDataSanPhamByTenAndMa
        (String input) throws Exception {
        String query = "SELECT sp.IDSanPham, sp.MaSanPham, sp.TenSanPham"
                + " FROM SanPham sp"
                + " WHERE ? IS NULL OR sp.MaSanPham LIKE ? OR sp.TenSanPham LIKE ?"
