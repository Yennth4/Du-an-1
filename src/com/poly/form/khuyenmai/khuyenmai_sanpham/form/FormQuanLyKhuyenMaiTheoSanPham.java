...
public class FormQuanLyKhuyenMaiTheoSanPham extends javax.swing.JPanel implements TableModelListener {
    ...
    public void init() throws Exception {
        this.tblDanhSachKhuyenMai.getTableHeader().setReorderingAllowed(false);

        this.tblDanhSachSanPham.getTableHeader().setReorderingAllowed(false);

        this.tblDanhSachSanPhamChiTiet.getTableHeader().setReorderingAllowed(false);
    ...
    public KhuyenMaiTheoSanPham readForm(String ma) {
        try {
            ...
            if (ten.length() > 255) {
                JOptionPane.showMessageDialog(this, "Tên khuyến mại không được quá 255 ký tự");
                return null;
            }

            boolean tonTai = repoSanPhamKhuyenMai.tonTai(ten);
            if (tonTai) {
                JOptionPane.showMessageDialog(this, "Tên khuyến mại đã tồn tại");
                return null;
            }
...
//            if (ngayBatDau < ngayTaoVaSua) {
//                JOptionPane.showMessageDialog(this, "Ngày bắt đầu phải là một ngày trong tương lai");
//                return null;
//            }
    ...
    public KhuyenMaiTheoSanPhamRequest readFormSearch() {
        ...
        try {
            String input = this.txtTimKiemMaOrTen.getText().trim();
    ...
    private void initComponents() {
        ...
        tblDanhSachSanPhamChiTiet.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        tblDanhSachSanPhamChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Mã", "Tên", "Màu", "Giá niêm yết", "Giá bán", "Giá sau áp dụng", "Giá giảm"
            }
        ) {
        ...
        jlbMaApDung.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jlbMaApDung.setForeground(java.awt.Color.red);

        jLabel20.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel20.setText("Tên:");

        txtTenApDung.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N

        jLabel23.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel23.setText("Giá trị:");

        jlbNgayBatDauApDung.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        jlbNgayKetThucApDung.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jlbNgayKetThucApDung.setForeground(java.awt.Color.red);

        txtGiaApDung.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N

        jLabel17.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel17.setText("Trạng thái: ");

        jlbTrangThaiApDung.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(txtGiaApDung, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(165, 165, 165))
        );
        ...
        txtTimKiemSanPham.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N

        jLabel10.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel10.setText("Tìm kiếm (Tên & Mã)");

        btnTimKiemSanPham.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(btnTimKiemSanPham, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        txtTimKiemSanPhamCT.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        txtTimKiemSanPhamCT.setEnabled(false);

        btnTimKiemSanPhamChiTiet.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btnTimKiemSanPhamChiTiet.setText("Tìm kiếm");
        btnTimKiemSanPhamChiTiet.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTimKiemSanPhamChiTietActionPerformed(evt);
            }
        });

        btnApDungSanPhamChiTiet.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        jpnFormThemSanPhamLayout.setHorizontalGroup(
            ...
            .addGroup(jpnFormThemSanPhamLayout.createSequentialGroup()
                ...
                .addGroup(jpnFormThemSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpnFormThemSanPhamLayout.createSequentialGroup()
                        .addComponent(btnTimKiemSanPhamChiTiet, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnApDungSanPhamChiTiet, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
        ...
        btnXoaMem.setText("Chỉnh sửa trạng thái");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnThem, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                        .addGap(47, 47, 47)
                        .addComponent(btnDonForm))
...
//        this.rdHoatDong.setSelected(true);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (readForm(ma) != null) {
            ...
            this.txtTenApDung.setText(txtTen.getText().trim());
    ...
    private void btnApDungSanPhamChiTietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApDungSanPhamChiTietActionPerformed
        int choice = JOptionPane.showConfirmDialog(this, "(Bạn có muốn áp dụng cho các sản phẩm trên) Chú ý khi áp dụng xong hệ thông chưa thể xem chi tiết khuyến mại ?", "Thông báo", JOptionPane.YES_NO_OPTION);
        if (choice == JOptionPane.YES_OPTION) {
            ...
            if (danhSachID != null) {
                ...
                if (ma != null) {
                    try {
                        ...
                        System.out.println(listSanPhamChiTiet.size());

                        if (listSanPhamChiTiet == null || listSanPhamChiTiet.size() == 0) {
                            JOptionPane.showMessageDialog(this, "Vui lòng chọn sản phẩm áp dụng khuyến mại");
                            return;
                        }
                        ...
                        for (int rowIndex = 0; rowIndex < tblDanhSachSanPham.getRowCount(); rowIndex++) {
                            tblDanhSachSanPham.setValueAt(false, rowIndex, 2);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(this, "Áp dụng thất bại");
                    }
    ...
    private void btnTimKiemSanPhamChiTietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemSanPhamChiTietActionPerformed
        JOptionPane.showMessageDialog(this, "Xin lỗi vì sự bất tiện hệ thống này hiện đang lỗi");
    }//GEN-LAST:event_btnTimKiemSanPhamChiTietActionPerformed
    ...
    private void btnTimKiemSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemSanPhamActionPerformed
        String resuil = txtTimKiemSanPham.getText().trim();
        try {
            this.listSanPham = repoSanPhamChiTiet.getAllDataSanPhamByTenAndMa(resuil);
            fillTableSanPham(listSanPham);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Tìm kiếm lỗi");
        }
