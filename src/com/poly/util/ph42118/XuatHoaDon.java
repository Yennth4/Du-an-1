...
public class XuatHoaDon {
    ...
    public static final String pathUnicode = "D:\\Da1_v8\\quanlybantui\\src\\com\\poly\\font\\unicode.ttf";
...
//  PdfFont font = PdfFontFactory.createFont(FontConstants.HELVETICA);
            ...
            customerInforTable.addCell(new Cell(0, 4)
                    .add("Thông tin nhân viên thêm").setBold().setBorder(Border.NO_BORDER));
            customerInforTable.addCell(new Cell().add("Họ tên: ").setBorder(Border.NO_BORDER));
            customerInforTable.addCell(new Cell().add(hoaDon.getTenNhanVien()).setBorder(Border.NO_BORDER));

            float itemColWidth[] = {15, 110, 170, 50, 200, 110};
...
//            itemTable.addCell(new Cell().add(df.format(tienKhachCK) + " Vnđ").setBackgroundColor(new DeviceRgb(63, 169, 219)).setBold().setBorder(Border.NO_BORDER).setFontColor(Color.WHITE));
            ...
            customerLoiChao.addCell(new Cell(0, 4)
                    .add("Cửa hàng túi da velisa cao cấp - Địa chỉ: Trịnh Văn Bô - Hà Nội").setItalic().setBorder(Border.NO_BORDER).setTextAlignment(TextAlignment.CENTER));
